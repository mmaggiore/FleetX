...
IF Request.Form("hdnHaveParms") = "YES" Then
	...
	reportname = "FleetX_Metrics_StandingOrders_AdminBilling.rpt"
...
<table  border="0" bordercolor="blue" align="center" class="MainPageText" width="100%">
	...
	Response.Write("<Div class='FleetXLargerBoldText'>FLEETX Standing Order Deliveries<br>(Admin - Billing)<BR><BR></Div>")
