...
oConn.Open DATABASE
l_cSQL=l_cSQL&"Select * from Order_Details_FleetX "
...
if not oRs.EOF then 
    ...
    'End if
        %>
	    <tr>
		    <td colspan="4"><span Class="MainPageTextBold"><%=PieceWord%>&nbsp;&nbsp;</span><span Class="MainPageText"><%=ListOfRefs%></span></td>
	    </tr>
	    <tr>
		    <td class="MainPageText" colspan="2">
			    <span class="MainPageTextBold"><%=DisplayBookTimeWord%> Time:  </span><%=Displaybooktime%>
		    </td>
		    <td class="MainPageText" colspan="2">
	    ...
	    <tr>
		    <td class="MainPageText" colspan="2" valign="top">
			    <span class="MainPageTextBold">Pickup Time:</span>&nbsp;&nbsp;<%=DisplayOnBoardTime%>
		    </td>
		    <td class="MainPageText" colspan="2" valign="top">
	    ...
	    <tr>
		    <td class="MainPageText" colspan="2" valign="top">
			    <span class="MainPageTextBold">Comments:  </span><%=DisplayFromComments%>
		    </td>
		    <td class="MainPageText" colspan="2" valign="top">
			    <span class="MainPageTextBold">Comments:  </span><%=DisplayToComments%>
		    </td>
	    </tr>
        <%
    ...
    'End if
        ...
        %>
 	     <tr>
		    <td class="MainPageText" colspan="4" valign="top">
			    <span class="MainPageTextBold">This job had a cancellation by a user<br /></span> -->
        <%
            CancelXID=oRs22("XID")
						...
						<%If trim(BILLTOID)="48" then
							...
							Set RSEVENTS22 = Server.CreateObject("ADODB.Recordset")
                                ...
                                If not RSEVENTS22.EOF then
									...
									<span class="MainPageTextBold">POD:</span>&nbsp;&nbsp;(<%=LotDocumentNumber%>)&nbsp;&nbsp;<a href="http://document.logisticorp.us:8080/LibertyIMS::/User=WebUser;pwd=Internet42;sys=LogistiCorp/Cmd%3DGetRawDocument%3BFolder%3D%2321%3BDoc%3D<%=HexULID%>%3Bformat%3DLIC/" target="_blank"><%=DisplaySignature%></a>&nbsp;
									<%
									else
									ULID=""
									...
									<span class="MainPageTextBold">POD:</span>&nbsp;&nbsp;(<%=LotDocumentNumber%>)&nbsp;&nbsp;<%=DisplaySignature%>&nbsp;
									<%
									End if
								End if
								RSEVENTS22.close
