...
Session("suid")="91"
    ...
    CurrentDateTime=Now()
    PageTitle="FLEETX METRICS-FREIGHT"
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
IF Request.Form("hdnHaveParms") = "YES" Then
	...
	reportname = "FleetX_Courier_Histogram.rpt"

Response.write "l_cEndDate="&l_cEndDate&"<BR>"
Response.write "l_cDate="&l_cDate&"<BR>"
...
Response.write "l_cDate="&l_cDate&"<BR>"
	...
	' SEcond param
SetParamValues "", "EndDate", CDate(l_cEndDate)
SetParamValues "", "StartDate", CDate(l_cDate)	
...
<table  border="0" bordercolor="blue" align="center" class="MainPageText" width="100%">
	...
	Response.Write("<Div class='FleetXLargerBoldText'>FLEETX COURIER HISTOGRAM<BR><BR></Div>")
