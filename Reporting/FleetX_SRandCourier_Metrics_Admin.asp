...
IF Request.Form("hdnHaveParms") = "YES" Then
	...
	reportname = "FleetX_Metrics_SRandCourier_AdminBilling.rpt"
...
<table  border="0" bordercolor="blue" align="center" class="MainPageText" width="100%">
	...
	Response.Write("<Div class='FleetXLargerBoldText'>FLEETX Stockroom and Courier Deliveries<br>(Admin - Billing)<BR><BR></Div>")
