...
Session("suid")="91"
    ...
    CurrentDateTime=Now()
    PageTitle="FLEETX ORDERS BY DRIVER"
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
IF Request.Form("hdnHaveParms") = "YES" Then
	...
	reportname = "FleetX_Metrics_ByDriver.rpt"
...
<table  border="0" bordercolor="blue" align="center" class="MainPageText" width="100%">
	...
	Response.Write("<Div class='FleetXLargerBoldText'>FLEETX Deliveries by Driver<BR><BR></Div>")
    ...
    <TR><td class="FleetXBoldText" align="center">Select your report criteria</td></TR>
            ...
            <tr>
				...
				<td colspan="3">
					<select name="SQLFromAddress">
                        ...
                        <option value="TISHR">TI-Sherman</option>
                    </select>
				</td>
			</tr>
            <tr><td>&nbsp;</td></tr>
