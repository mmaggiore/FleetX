...
'''''''''''''''''END - WIPE OUT ALL THE COOKIES!!!'''''''''''''''''
  ...
  ''''''''''''''''LETTER to Requestor'''''''''''''''''''
                    ...
                    Body = Body & "***Should you need to cancel this order, please call 817-458-4594***<BR><BR>"
				    ...
				    objMail.Body = Body
                    If trim(lcase(SentToEmail))<>"FleetX@LogisticorpGroup.com" then
				        objMail.Send
                    End if
				    Set objMail = Nothing         
                    ...
                    If (int(DimLength)>42 or int(DimWidth)>48 or int(DimHeight)>48) AND xyz="removethisfornow" then
				        Body = "There has been an oversized FleetX shipment request (#"& newjobnum &") placed online:<br><br>"   
                    ...
                    <table border="0" bordercolor="<%=BorderColor%>" cellpadding="3" cellspacing="0" width="<%=tablewidth%>" align="center"> 
                     <tr>
                        ...
                        <td align="left"  class="FleetExpressTextBlack" nowrap="nowrap">
                            <input type="text" name="MaterialDescription" value="<%=MaterialDescription %>" maxlength="50" /> (Ex. Control/Part Number, Documents, machine parts)
                        </td>
                    </tr>                   
                    <tr>
...
<%
 ...
 %>
                ...
                If DayOfWeek>1 and DayOfWeek<7 then
                        ...
                        If (StandingReadyTime=12 or StandingReadyTime=11 or StandingReadyTime=13 or StandingReadyTime=14) and left(companyaddress, 7)="12500 T" and left(bcompanyaddress,7)="13536 N" then
                            StandingOrderID=6
