...
<script language="javascript" type="text/javascript" src="datetimepicker.js">
  ...
  ''''''''''''''''LETTER to Requestor'''''''''''''''''''
				    ...
				    objMail.Subject = "Changes to your FleetX shipment request"
...
<form method="post" name="OrderForm1" action="fleetexpressOrderEdit.asp">
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="900">
        ...
        <tr><td align="left" colspan="2"><img src="images/pixel.gif" /></td></tr>
         <tr><td align="center" bgcolor="<%=HeaderBorderColor%>" class="RaytheonHeaderWhite" colspan="2">Edit A Fleet Express Transportation Request<%If trim(SearchJobNumber)>"" then%>-Job #<%=SearchJobNumber %><%End if %></td></tr>
        ...
        <tr>
         ...
         <tr><td align="left"><img src="images/pixel.gif" height="10" width="1" /></td></tr>
         <tr><td align="center" bgcolor="<%=HeaderBorderColor%>" class="RaytheonHeaderWhite" colspan="2">Fleet Express Transportation Call Center 972-499-3415</td></tr>
         <tr><td align="left"><img src="images/pixel.gif" height="10" width="1" /></td></tr>
         <tr>
            <td align="right">
        ...
        <%Case Else %>
            <form method="post" action="fleetexpressOrderEdit.asp">
            <tr><td>&nbsp;</td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>&nbsp;</td></tr>
                    ...
                    <table>
                        ...
                        <%
			                ...
			                RSEVENTS2.Open DATABASE
                                ...
                                %>
                                <tr><td><a href="fleetexpressOrderEdit.asp?SearchJobNumber=<%=fh_ID %>&PageStatus=FindAJob"><%=fh_ID %></a></td><td width="20">&nbsp;</td><td><%=fh_ship_dt %></td><td width="20">&nbsp;</td><td><%=fl_sf_name %></td><td width="20">&nbsp;</td><td><%=fl_st_name %></td></tr>
                                <%
								oRs.movenext
								LOOP
                                oRs.close
        ...
        <tr><td align="center">
          ...
          <form method="post" action="../../FleetExpressDeliveries.asp?BTID=86">
                            ...
                            <input type="submit" name="submit" value="POD Order" />
                            <input type="hidden" name="btid" value="86" />
           </form>
           </td>
           <td>
