...
<script language="javascript" type="text/javascript" src="datetimepicker.js">
  ...
  ''''''''''''''''LETTER to Requestor'''''''''''''''''''
				   ...
				   ' Set objMail = CreateObject("CDONTS.Newmail")
				    ...
				    varTo = SentToEmail
				    varcc = "mark.maggiore@logisticorp.us;fleetexpress@LogistiCorp.us"
				    'objMail.cc = "4692269939@tmomail.net;pcurrin@ti.com"
				    varSubject = "Changes to your Fleet Express shipment request"
...
<%
									...
									oConn.Provider = "MSDASQL"
									oConn.Open DATABASE
									    l_cSQL = "Select * FROM Priorities WHERE priorityorigination<>'TI-Sherman' and  prioritystatus='c' and priority_BT_ID in(93) ORDER BY PriorityMinutes desc"
