    ...
    <tr><td width="100%" align="center" valign="top">
	 ...
	 <TABLE WIDTH="100%" valign="top" border="0" bordercolor="red" cellpadding="0" cellspacing="5" ID="Table1">
		...
		<table cellpadding="0" valign="top" cellspacing="0" border="0" bordercolor="brown" align="center" ID="Table2">  
			<tr><td class="MainPageText">To track an order:<br />1. Provide either a complete order number or a complete document number. 
...
<%end if %>
    ...
    End if
If trim(jobnumber)="" and trim(ReferenceNumber)="" then
        ErrorMessage="You must provide either an order number or a document number"
End if
