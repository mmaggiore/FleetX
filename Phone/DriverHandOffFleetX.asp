...
'-------------------STARTS THE PICK UP
			...
			End If				
				...
				'''''''''''''''''''''''''''''
					...
					oConn.Open DATABASE
                        ...
                        'If handoffUnitID<>123 and HandOffUnitID<>124  then
                            If lcase(trim(jobstat))="ac2" or lcase(trim(jobstat))="arv" or lcase(trim(jobstat))="dpv" then
                                'REsponse.write "GOT HERE #1<BR>"
                                oConn.Execute "PHONE_CHANGE_STATUS '" & JobNumber & "', '55', 'AC2', '','','',''"
                                n_cSQL = "UPDATE FCLEGS SET fl_un_id = '"&UnitID&"', fl_dr_id = '"&VehicleID&"', fl_seconb = '' WHERE fl_fh_id = '" & JobNumber&"'"
                                z_cSQL = "UPDATE Report_data SET fl_un_id = '"&UnitID&"', fl_dr_id = '"&VehicleID&"', fl_seconb = '' WHERE fh_id = '" & JobNumber&"'"
                                else
                                'REsponse.write "GOT HERE #2<BR>"
						        oConn.Execute "PHONE_CHANGE_STATUS '" & JobNumber & "', '4', 'ACC', '','','',''"
                                n_cSQL = "UPDATE FCLEGS SET fl_un_id = '"&UnitID&"', fl_dr_id = '"&VehicleID&"', fl_t_atp='' WHERE fl_fh_id = '" & JobNumber&"'"
                                z_cSQL = "UPDATE Report_data SET fl_un_id = '"&UnitID&"', fl_dr_id = '"&VehicleID&"', fl_t_atp='' WHERE fh_id = '" & JobNumber&"'"
                            End if 
                        'End if
                ...
                If handoffUnitID=123 or HandOffUnitID=124 then
                    SQL = SQL&" AND ((fh_status='ACC') OR (fh_status='ONB') OR (fh_status='OPN') OR (fh_status='ARV') OR (fh_status='AC2')) AND ((FL_Leg_Status='c') OR (FL_Leg_Status is NULL))"
                    else
				    SQL = SQL&" AND ((fh_status='ACC') OR (fh_status='OPN') OR (fh_status='ARV') OR (fh_status='AC2')) AND ((FL_Leg_Status='c') OR (FL_Leg_Status is NULL))"
                End if
				SQL = SQL&" ORDER BY fh_id"
				oRs.Open SQL, DATABASE, 1, 3
					...
					<TR> 
						<td> 
								<table border="0" bordercolor="blue" width="300" cellpadding="0" cellspacing="0" ID="Table4">
									...
									'Response.Write "unitid="&unitid&"***<BR>"
									Select Case UnitID
										Case "303551", "303552", "303553", "303554", "srvrfab"
											%>	
											<%if UnitID<>"srvrfab" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form22">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="RFAB Van" ID="Submit21">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="srvrfab">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden46">
											</FORM>
											<tr> 
										...
										Case "ofb"
											...
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="On Call Vehicle" ID="Submit3">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="ocv" ID="Hidden13">
                                            ...
                                            <tr><td>&nbsp;</td></tr>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form23">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="RFAB Van" ID="Submit22">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="srvrfab" ID="Hidden47">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden48">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
                                            ...
                                            <tr><td>&nbsp;</td></tr>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form24">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="Stockroom Van" ID="Submit23">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="srv" ID="Hidden49">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden50">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
										...
										Case "srv", "SHERMAN", "OCV"
											...
											if UnitID="srv" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form26">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="Stockroom Material Handler" ID="Submit25">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="srb" ID="Hidden53">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden54">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
										...
										Case "1", "2", "3", "4", "5", "6"
											...
											<%if UnitID<>"1" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form15">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Van 1" ID="Submit14">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="1" ID="Hidden27">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden28">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
											...
											<%if UnitID<>"2" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form16">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Van 2" ID="Submit15">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="2" ID="Hidden29">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden30">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
											...
											<%if UnitID<>"3" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form17">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Spring Creek" ID="Submit16">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="3" ID="Hidden31">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden33">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
											...
											<%if UnitID<>"4" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form18">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Stafford Bobtail" ID="Submit17">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="4" ID="Hidden38">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden39">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>	
											...
											if UnitID<>"5" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form19">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Stafford TT" ID="Submit18">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="5" ID="Hidden40">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden41">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>	
											...
											<%End if
											if UnitID<>"6" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form20">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Sherman" ID="Submit19">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="6" ID="Hidden42">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden43">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>	
											...
											if UnitID<>"7" Then%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form21">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="KWE Alliance" ID="Submit20">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="7" ID="Hidden44">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden45">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>	
										...
										Case "srb"
											%>
											<FORM ACTION="DriverHandOff.asp" method="post" name="thisForm" ID="Form25">								
											<tr>
												<td class='generalcontent'>
													<input type="submit" name="submit" value="Stockroom Van" ID="Submit24">									
												</td>
											</tr>
											<input type="hidden" name="HandOffUnitID" value="srv" ID="Hidden51">
											<input type="hidden" name="PageStatus" value="ShowOrders" ID="Hidden52">
											</FORM>
											<tr> 
												<td class="subheader" colspan="2"><img src="../images/transpixel.gif" height="2"></td>
											</tr>									
