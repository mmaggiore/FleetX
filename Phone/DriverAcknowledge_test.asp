...
'-------------------STARTS THE OTHER ORDERS IN THE PHONE		
				...
				SQL = "SELECT Fl_SF_ID, Fh_ID, fh_ship_dt, Fl_ST_ID, FH_Status, Fh_Priority FROM fcfgthd INNER JOIN fclegs ON fcfgthd.fh_id = fclegs.fl_fh_id"
				...
				%>
					<table cellpadding="0" width="300" cellspacing="0" bordercolor="red" border="0" align="left" ID="Table5">
						...
						If not oRs.EOF then
							...
							CloseTable="y"
							ELSE
							Response.Write "<tr><td colspan='3' align='center'>There are currently no unacknowledged orders.</td></tr><tr><td>&nbsp;</td></tr><tr><td align='center'><a href='default.asp' class='mainpagelink'>Return Home 3</a></td></tr>"
						End if
						...
						'FromLocation = oRs("Fl_SF_ID")
							Y=Y+1
									...
									<tr><td valign="top" width="40" rowspan="3"><input type="submit" value="<%=ButtonText%>" name="submit" class="<%=ButtonGrey%>" ID="Submit3"></td>
							...
							Response.Write "<td class='mainpagetextboldright'>Job Info:&nbsp;&nbsp;</td><td valign='top' nowrap><font color='"&PriorityColor&"'>"&JobNumber&" / "&Priority&" / "&NumberOfLots&" "&WordLots&"</font></td></tr>"
							Response.Write "<tr><td class='mainpagetextboldright'>Ordered:&nbsp;&nbsp;</td><td valign='top' nowrap><font color='"&PriorityColor&"'>"&TimeSincePlaced&" minutes ago</font></td></tr>"
							Response.Write "<tr><td class='mainpagetextboldright'>Lane:&nbsp;&nbsp;</td><td valign='top' nowrap><font color='"&PriorityColor&"'>"&FromLocation&" to "&ToLocation&"</font></td></tr>"
							Response.Write "</form>"
						...
						If CloseTable="y" then
							%>
							<tr><td>&nbsp;</td></tr>
							<tr><td align="center" colspan="3"><a href="default.asp" class="mainpagelink">Return Home 4</a></td></tr><tr><td>&nbsp;</td></tr></table>					
							<%
							CloseTable="n"
						End if					
					Case else
