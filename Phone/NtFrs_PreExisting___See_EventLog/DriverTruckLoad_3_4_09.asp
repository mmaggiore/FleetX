		...
		<table width="300" cellpadding="0" cellspacing="0" border="0" align="left" ID="Table2">
			...
			Do while not oRs.eof
				...
				If TempToLocation<>ToLocation then
					...
					End if
					If Trim(FromLocation)="55" or Trim(FromLocation)="CPGP" or Trim(FromLocation)="72" or (Trim(FromLocation)="TOPPAN" or (Trim(FromLocation)="PHO")) then
