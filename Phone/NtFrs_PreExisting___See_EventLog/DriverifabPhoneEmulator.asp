						...
						Select Case JobStatus
							Case "Acknowledged","ONB", "Paper on Board"
								''''If show2=0 then
									...
									If (Request.Cookies("FleetXPhone")("sBT_ID")<>"26" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"80"  AND Request.Cookies("FleetXPhone")("sBT_ID")<>"48" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"75" AND MaterialType<>"xxxSecure Waf") OR (Request.Cookies("FleetXPhone")("sBT_ID")="26" AND trim(FromLocation)="PHO") then
										'Response.Write "cookie?(sBT_ID)="&Request.Cookies("FleetXPhone")("sBT_ID")&"<BR>"
										'Response.Write "BillToID="&BillToID&"<BR>"
...
'-------------------STARTS THE PICK UP	
				...
				End if
				If HUB="y" and (trim(VehicleID)="124" or trim(vehicleID)="113") then
					SQL = SQL&" OR (Fl_st_ID='D6W3')"
					SQL = SQL&" OR (Fl_st_ID='D6N2')"
					SQL = SQL&" OR (Fl_st_ID='D6N1')"
					SQL = SQL&" OR (Fl_st_ID='DM4M')"
						...
						Select Case JobStatus
							Case "Acknowledged","ONB", "ARV", "AC2"
								''''If show=0 then
									...
									If Request.Cookies("FleetXPhone")("sBT_ID")<>"26" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"48" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"75" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"80"   then
										%>
