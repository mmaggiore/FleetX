		...
		For intRecord = 1 to oRS.PageSize	
					...
					'Response.Write TempX&"</font></td></tr>"
						...
						''''''''''''''''''''''''''''''''
											...
											If (Trim(ToLocation)="TOPPAN" or Trim(ToLocation)="CPGP" or Trim(ToLocation)="72" or Trim(ToLocation)="PHO") and (trim(VehicleID)<>"611" AND trim(VehicleID)<>"612" AND trim(VehicleID)<>"613" AND trim(VehicleID)<>"112" AND trim(VehicleID)<>"123") then
