		...
		<table width="300" cellpadding="0" cellspacing="0" border="0" align="left" ID="Table2">
			...
			Do while not oRs.eof
				...
				If TempToLocation<>ToLocation then
					...
					If (FromLocation="55" OR FromLocation="TOPPAN" OR FromLocation="PHO") AND (trim(vehicleID)="611" or trim(VehicleID)="612" or trim(VehicleID)="613" or trim(VehicleID)="112" or trim(VehicleID)="123") then
						DisplayToLocation="SB-HUB"
			...
			Do while not oRs.eof
				...
				If TempToLocation<>ToLocation then
					...
					'Response.Write "*********************GOT HERE!<BR>"
					DisplayToLocation=trim(ToLocation)
					If (Trim(ToLocation)="TOPPAN" or Trim(ToLocation)="CPGP" or Trim(ToLocation)="PHO" or Trim(ToLocation)="72") and (trim(VehicleID)<>"611" AND trim(VehicleID)<>"612" AND trim(VehicleID)<>"613" AND trim(VehicleID)<>"112" AND trim(VehicleID)<>"123") then
						DisplayToLocation="SB-HUB"
			...
			Do while not oRs.eof
				...
				If TempToLocation<>ToLocation OR TempFromLocation<>FromLocation then
					...
					If (Trim(ToLocation)="55" or Trim(ToLocation)="72" or Trim(ToLocation)="TOPPAN" or Trim(ToLocation)="PHO") AND (trim(VehicleID)<>"611" AND trim(VehicleID)<>"612" AND trim(VehicleID)<>"613" AND trim(VehicleID)<>"112" AND trim(VehicleID)<>"123") then
						DisplayToLocation="SB-HUB"
					...
					End if					
					If Trim(FromLocation)="55" or Trim(FromLocation)="72" or Trim(FromLocation)="TOPPAN" or Trim(FromLocation)="PHO" or (Trim(FromLocation)="HFABRET") then
						DisplayFromLocation="SB-HUB"
			...
			Do while not oRs.eof
				...
				If TempToLocation<>ToLocation OR TempFromLocation<>FromLocation then
					...
					If Trim(FromLocation)="55" or Trim(FromLocation)="72" or Trim(FromLocation)="TOPPAN" or Trim(FromLocation)="PHO" or (Trim(FromLocation)="HFABRET") then
						...
						DisplayFromLocation="SB-HUB"
								If (trim(VehicleID)="611" or trim(VehicleID)="612" or trim(VehicleID)="613" or trim(VehicleID)="112" or trim(VehicleID)="123") and (Trim(ToLocation)<>"PHO") and (Trim(ToLocation)<>"TOPPAN") then
...
'''''''''''''''''''''''''''''''''''''''					
					...
					End if
					If Trim(ToLocation)="CPGP" and (trim(VehicleID)="611" or trim(VehicleID)="612" or trim(VehicleID)="613" or trim(VehicleID)="112" or trim(VehicleID)="123") then
						DisplayFromLocation="SB-HUB"
						'Response.Write "got here 2<BR>"
					End if
