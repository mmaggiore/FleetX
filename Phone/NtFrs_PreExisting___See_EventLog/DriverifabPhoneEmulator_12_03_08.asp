...
'-------------------STARTS THE DROP OFF				
				...
				If HUB3="y" then
					''''Response.Write "got here 1<br>"
					SQL = SQL&" (((Fl_st_ID='CPGP') or (Fl_sf_ID='55') or (FL_ST_ID='TOPPAN') or (FL_SF_ID='TOPPAN') or (FL_SF_ID='PHO') or (FL_ST_ID='PHO')) AND (Fh_Status<>'DPV') )"
				End if								
				For mm=1 to m
				'''''Response.Write "got here 2<br>"
...
'-------------------STARTS THE PICK UP	
				...
				If HUB3="y" and (trim(vehicleID)="611" or trim(vehicleID)="612" or trim(vehicleID)="613" or trim(vehicleID)="112" or trim(vehicleID)="123") then
					SQL = SQL&" OR (Fl_st_ID='CPGP') OR (Fl_st_ID='55') OR (Fl_st_ID='72') OR (FL_st_ID='TOPPAN') OR (FL_st_ID='PHO')"
				End if	
