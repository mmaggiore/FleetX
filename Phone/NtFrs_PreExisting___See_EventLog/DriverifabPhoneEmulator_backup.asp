...
'-------------------STARTS THE PICK UP	
				...
				If SetArrivalTime="y" and BillToID="48" then
						...
						SQL = "SELECT fl_fh_id FROM fclegs"
						SQL = SQL&" WHERE (Fl_sf_ID='"&trim(LocationCode)&"') AND (fl_t_und = '1/1/1900') AND (Fl_dr_ID='"&trim(VehicleID)&"') AND (fl_t_int > '1/1/1900')"
