				       ...
				       ' Response.Write "X66="&X66&"<BR>"
						...
						Select Case AllVehicle
						    Case "312"
						        ...
						        If AllPriority="P0" or AllPriority="XP" or AllMaterialType="Secure Waf" or AllMaterialType="ITAR" then
						            XP303551=XP303551+1
						        End if
	...
	<table cellspacing="0" cellpadding="0" border="0" width="300">
		...
		%>
		    ...
		    <%If ucase(UnitID)="SRVRFAB" then %>
		        <tr><td class="mainpagetextbold">W4: <font color="<%=JobFontSRVRFAB%>">Jobs=<%=NumJobsSRVRFAB%></font> / <font color="<%=XPFontSRVRFAB%>">P0=<%=XPSRVRFAB%></font> / <font color="<%=LateFontSRVRFAB%>">Late=<%=LateSRVRFAB%></font></td></tr>
		    <%End if%>
		<%end if %>
		<tr><td>&nbsp;</td></tr>
