	...
	'					Do while not oRs.eof
						...
						End Select
							...
							If Trim(FromLocation)="55" or Trim(FromLocation)="72" or Trim(FromLocation)="TOPPAN" or Trim(FromLocation)="PHO" or Trim(FromLocation)="HFABRET" then
								...
								If (trim(VehicleID)="611" or trim(VehicleID)="612" or trim(VehicleID)="613" or trim(VehicleID)="112" or trim(VehicleID)="123") AND Trim(ToLocation)<>"PHO" AND Trim(ToLocation)<>"HFABRET" then
									'response.Write "GOT HERE!!!<BR>"
