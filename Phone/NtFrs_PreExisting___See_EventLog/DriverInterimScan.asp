...
'-------------------STARTS THE DROP OFF				
						...
						Select Case JobStatus
							Case "Acknowledged","ONB"
								''''If show2=0 then
									...
									If (Request.Cookies("FleetXPhone")("sBT_ID")<>"26"  AND Request.Cookies("FleetXPhone")("sBT_ID")<>"48" AND Request.Cookies("FleetXPhone")("sBT_ID")<>"75"  AND MaterialType<>"xxxSecure Waf") OR (Request.Cookies("FleetXPhone")("sBT_ID")="26" AND trim(FromLocation)="PHO") then
			...
			%>
				...
				<br clear="all">
			<FORM ACTION="DriverInterimScan.asp" method="post" name="thisForm" ID="Form6">
