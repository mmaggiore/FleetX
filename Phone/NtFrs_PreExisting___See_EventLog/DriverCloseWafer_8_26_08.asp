...
Recordset1_numRows = 0
	if NOT Recordset1.EOF then
		...
		'SecondDriverVerified="y"
		'DriverEmail=Recordset1("Email")
		'VehicleSet=Recordset1("DriverVehicle")
		'Response.write "LOGGED IN!"
		'LoggedIn="yes"
		'Response.Cookies("Phone")("VehicleSet")=VehicleSet
		'Response.Cookies("Phone")("DriverEmail")= DriverEmail
		'Response.Cookies("Phone")("DriverUserID") = UserID
		'Response.Cookies("Phone")("DriverFirstName") = FirstName
		'Response.Cookies("Phone")("DriverLastName") = LastName
		'Recordset1.Close()
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''					
					...
					If not oRs.eof and trim(ErrorMessage)="" then
						...
						If tempDestination="HBUMP" or tempDestination="TOPPAN" or tempDestination="CPGP" then	
							Response.Write "GOT HERE!!!<BR>"
						...
						''''''''''''''''''''''''''''''''''''''''	
						''''''''''''''''''CHANGES THE PRIORITY TIME FOR TOPPAN AND HBUMP'''''''''''''''''''''''
						If tempOrigination="HBUMP" or tempOrigination="TOPPAN" or tempOrigination="55" then	
							''Response.Write "GOT HERE!!!<BR>"
