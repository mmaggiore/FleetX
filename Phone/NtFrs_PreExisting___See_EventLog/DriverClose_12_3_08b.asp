...
'response.Write "locationcode="&LocationCode&"<BR>"
		If UCASE(LocationCode)="EBHUB" or UCASE(LocationCode)="13536" or UCASE(LocationCode)="SB-HUB" then
			If UCASE(LocationCode)="EBHUB" then
				BillToID="26"
				LocationCode="EBHUB"
				Hub="y"
				If UCASE(LocationCode="SH-HUB") then
					BillToID="36"
					LocationCode="SB-HUB"
					Hub="y"				
					Else
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''					
			...
			''''''''''''''''''''email notification BEGIN
						...
						''''''''''''''''''''''''''''''''''''''''''''''''
							...
							If ((trim(VehicleID)<>124 AND trim(VehicleID)<>123) or trim(LocationCode)="ESTK") and trim(LocationCode)<>"13536" or trim(The2Address)="TISHERMA"  then
