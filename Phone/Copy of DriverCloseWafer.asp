...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
					...
					If PageStatus="ONB" then
						If BillToID="48" then
							...
							SQL = SQL& "AND (ref_status is NULL)) OR ((fh_status='AC2') AND (ref_status='Q')) )"
						End if
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''					
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''					
					'response.write "<br><font color='blue'>vvvFirst Select="&SQL&"<BR></font>"
			...
			Set RSEVENTS2 = Server.CreateObject("ADODB.Recordset")
				...
				''Response.write "l_csql="&l_csql&"<BR>"		
						...
						If BillToID="48" then
							...
							l_csql = L_csql& "AND (ref_status is NULL)) OR ((fh_status='AC2') AND (ref_status='Q'))) "
						End if
