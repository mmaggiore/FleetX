...
IF l_cJobNum="" THEN ''''''1
	...
	ELSE ''''2
		...
		l_cSQL = "SELECT fh_co_id, fh_status, fh_custpo, fh_priority, " & _
				...
				"csf.st_email AS sf_email, cst.st_email AS st_email, fh_user4, fh_user3, " & _			
				"fl_st_area, fl_sf_area, fl_totrate, fp_desc, asf.ae_desc as SFArea, " & _
				"ast.ae_desc as STArea, bt_desc " &_
				"FROM fclegs " & _
				"JOIN fcfgthd ON fl_fh_id = fh_id " & _
				"JOIN fcbillto ON fh_bt_id = bt_id " & _
				"LEFT OUTER JOIN fcshipto csf ON fl_sf_id = csf.st_id " & _
				"LEFT OUTER JOIN fcshipto cst ON fl_st_id = cst.st_id " & _
				"LEFT OUTER JOIN fcprior ON fh_priority = fp_id " & _
				"LEFT OUTER JOIN fcarea asf ON fl_sf_area = asf.ae_sysid " & _
				"LEFT OUTER JOIN fcarea ast ON fl_st_area = ast.ae_sysid " & _
    ...
    <TABLE WIDTH=100% BORDER=1 Align='left' cellpadding="0" cellspacing="0">
        ...
        <TR>
            ...
            <TD width="50%"><FONT FACE='Arial'><b>Booked Date:</b> <%=l_tBookdate%><br /><FONT FACE='Arial'><b>Priority:</b> <%=l_cPriority%></FONT></TD>
