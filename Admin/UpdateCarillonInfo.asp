...
<%
    ...
    'Response.write "CompanyAddress="&CompanyAddress&"****<BR>"
If not IsNumeric(CarillonID) and ButtonValue="UPDATE" then
...
If CarillonID>"" then
					...
					Set RSEVENTS2 = Server.CreateObject("ADODB.Recordset")
						...
						RSEVENTS2.addnew
						RSEVENTS2("CarillonID")=CarillonID
...
'Response.write "Database="&Database&"<br>"
Recordset1.ActiveConnection = Database
SQL = "SELECT Top 20 CarillonID, ST_ID, CompanyName, CompanyAddress, CompanyBuilding, CompanySuite FROM PreExistingCompanies WHERE (CompanyStatus = 'c') AND (CarillonID < 1 OR CarillonID IS NULL) and companyID>0 Order by CompanyAddress"
Recordset1.Source = SQL
'response.write "SQL="& SQL &"<BR>"
Recordset1.CursorType = 0
Recordset1.CursorLocation = 2
...
<tr><td>&nbsp;</td></tr>
<tr><td  nowrap="nowrap" ><b>&nbsp;</b></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><b>Carillon ID</b></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><b>Company Name</b></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><b>Address</b></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><b>Building</b></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><b>Suite</b></td></tr>
<%
	if NOT Recordset1.EOF then
    ...
    <form method="post" action="UpdateCarillonInfo.asp">
        <tr><td><INPUT id="gobutton" TYPE="submit" name="ButtonValue" VALUE="UPDATE"></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td  nowrap="nowrap" ><input type="text" name="CarillonID" maxlength="10" /></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><%=CompanyName%></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td><%=CompanyAddress%></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td  nowrap="nowrap" ><%=CompanyBuilding %></td><td><img src="../images/pixel.gif" height="1" width="5" /></td><td  nowrap="nowrap" ><%=CompanySuite %></td></tr>
