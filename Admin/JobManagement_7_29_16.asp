...
If DontShowThisAnymore="NEVER" then
				...
				Recordset166_numRows = 0
                    ...
                    oConn.Open DATABASE
                        ...
                        If trim(SendToEmail)>"" then
						    ...
						    objMail.Subject = "FleetX Delivery (Updated by Supervisor)"
		...
		<tr><td colspan="6" align="center">
			<table border="1" cellspacing="0" cellpadding="3" ID="Table4" bordercolor="gray">
				...
				Set RSEVENTS246 = Nothing                        
						...
						<tr><td nowrap class="MainPageTextRightBold">Driver Ack</td><td>DATE:&nbsp;<input size="8" type="text" name="Leg_fl_t_acc_date" value="<%=FormatDateTime(Leg_fl_t_acc, 2)%>" ID="date_1">TIME:&nbsp;<input size="8" type="text" name="Leg_fl_t_acc_time" value="<%=FormatDateTime(Leg_fl_t_acc, 3)%>" ID="time_1"></td></tr>
						<%if abc="XYZ" then%>
							<tr><td nowrap class="MainPageTextRightBold">Paper on Board</td><td><input type="text" name="Leg_fl_t_int" value="<%=Leg_fl_t_int%>" ID="Text11"></td></tr>
							<tr><td nowrap class="MainPageTextRightBold">At Airline</td><td><input type="text" name="Leg_fl_t_und" value="<%=Leg_fl_t_und%>" ID="Text12"></td></tr>
						<%end if
                        'Response.write "Leg_fl_t_atd="&Leg_fl_t_atd&"<BR>"
                        %>
						<tr><td nowrap class="MainPageTextRightBold">On Board</td><td>DATE:&nbsp;<input size="8"  type="text" name="Leg_fl_t_atp_date" value="<%=FormatDateTime(Leg_fl_t_atp, 2)%>" ID="date_2">TIME:&nbsp;<input size="8"  type="text" name="Leg_fl_t_atp_time" value="<%=FormatDateTime(Leg_fl_t_atp, 3)%>" ID="time_2"></td></tr>
						<tr><td nowrap class="MainPageTextRightBold">Dropped</td><td>DATE:&nbsp;<input size="8"  type="text" name="Leg_fl_t_atd_date" value="<%=FormatDateTime(Leg_fl_t_atd, 2)%>" ID="date_3">TIME:&nbsp;<input size="8"  type="text" name="Leg_fl_t_atd_time" value="<%=FormatDateTime(Leg_fl_t_atd, 3)%>" ID="time_3"></td></tr>
						<%'end if%>
