...
function Calendar(p_item, p_WinCal, p_month, p_year, p_format) {
	...
	this.gBGColor = "#DAE9FD";
	this.gFGColor = "#0D3670";
...
//	this.wwriteA("</B><BR>");
	...
	this.wwrite("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=1 BGCOLOR='#DFE4EB'><TR><TD WIDTH='7%' ALIGN=center><FONT SIZE=1>");
	this.wwrite("[&nbsp;<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><<<\/A>&nbsp;]</FONT></TD><TD WIDTH='7%' ALIGN=center><FONT SIZE=1>");
	this.wwrite("[&nbsp;<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><<\/A>&nbsp;]</FONT></TD><TD  WIDTH='72%'ALIGN=center><FONT FACE='" + fontface + "'SIZE=1>");
	this.wwriteA(this.gMonthName + " " + this.gYear);
	this.wwrite("</FONT></TD><TD WIDTH='7%' ALIGN=center><FONT SIZE=1>");
	this.wwrite("[&nbsp;<A HREF=\"" +
		"javascript:window.opener.Build(" + 
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#DFE4EB'><TR><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', null, '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\" alt='Prev Year'><<<\/A>]</TD><TD ALIGN=center>");
	this.wwrite("March 2002</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
	...
	*/
	...
	for (m=1; m<(7-j); m++) {
		if (this.gYearly)
			...
			"><FONT SIZE='1' FACE='" + fontface + "' COLOR='#142F6F'> </FONT></TD>";
		else
			vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j+m) + 
			"><FONT SIZE='1' FACE='" + fontface + "' COLOR='#142F6F'>" + m + "</FONT></TD>";
	}
...
function Build(p_item, p_month, p_year, p_format) {
	...
	gCal.gBGColor="#EAEEF2";
	gCal.gLinkColor="black";
	gCal.gTextColor="black";
	gCal.gHeaderColor="#0D3670";
